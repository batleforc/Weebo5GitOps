...
{{/*
Common token secret job labels
*/}}
{{- define "netbird.managementTokenSecretJob.labels" -}}
helm.sh/chart: {{ include "netbird.chart" . }}
{{ include "netbird.managementTokenSecretJob.selectorLabels" . }}
app.kubernetes.io/managed-by: {{ .Release.Service }}
{{- end }}
...
{{/*
managementTokenSecretJob selector labels
*/}}
{{- define "netbird.managementTokenSecretJob.selectorLabels" -}}
app.kubernetes.io/name: {{ include "netbird.name" . }}-management-token-secret-job
app.kubernetes.io/instance: {{ .Release.Name }}
{{- end }}
...
{{/*
Create the name of the management token secret job service account to use
*/}}
{{- define "netbird.managementTokenSecretJob.serviceAccountName" -}}
{{- if .Values.managementTokenSecretJob.serviceAccount.create }}
{{- default (printf "%s-management-token-secret-job" (include "netbird.fullname" .)) .Values.managementTokenSecretJob.serviceAccount.name }}
{{- else }}
{{- default "default" .Values.managementTokenSecretJob.serviceAccount.name }}
{{- end }}
{{- end }}

{{/*
Create the rolebinding name for the managementTokenSecretJob service account
*/}}
{{- define "netbird.managementTokenSecretJob.roleBindingName" -}}
{{- printf "%s-management-token-secret-job" (include "netbird.fullname" .) }}
{{- end }}

{{/*
Create the role name for the managementTokenSecretJob role
*/}}
{{- define "netbird.managementTokenSecretJob.roleName" -}}
{{- printf "%s-management-token-secret-job" (include "netbird.fullname" .) }}
{{- end }}
