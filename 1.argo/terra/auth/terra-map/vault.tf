  ...
  allowed_redirect_uris = [
    {
      ...
      url           = "https://vault.batleforc.fr/ui/vault/auth/authentik/oidc/callback",
    },
    {
      matching_mode = "strict",
      url           = "https://vault.batleforc.fr/authentik/callback",
    },
    {
      matching_mode = "strict",
...
resource "vault_jwt_auth_backend" "vault_authentik" {
  ...
  path               = "authentik"
  type               = "oidc"
  oidc_discovery_url = "https://auth.batleforc.fr/application/o/${authentik_application.vault.slug}/"
...
resource "vault_jwt_auth_backend_role" "vault_authentik_reader" {
  ...
  allowed_redirect_uris = [
    "https://vault.batleforc.fr/ui/vault/auth/authentik/oidc/callback",
    "https://vault.batleforc.fr/authentik/callback",
